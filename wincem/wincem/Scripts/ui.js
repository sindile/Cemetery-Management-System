...
function init() {
    BurialsFeatureLayer = new esri.layers.FeatureLayer(config.burials);
}
    ...
    var pageInit = 1;
        $('#cemeterySelect').change(function () {
            ...
            if (selectedCemetery != null && selectedCemetery != '') {
                $.getJSON( config.divisions + '?where=Cemetery_ID%3D' + selectedCemetery +
        ...
        $('#divisionSelect').change(function () {
            ...
            if (selectedDivision != null && selectedDivision != '') {
                $.getJSON( config.blocks + '?where=Division_ID%3D\'' + division_ID +
        ...
        $('#blockSection').change(function () {
            ...
            if (selectedDivision != null && selectedDivision != '') {
                $.getJSON( config.lots + '?where=Block_Section_ID%3D\'' + Block_Section_ID +
        ...
        $('#lotRow').change(function () {
            ...
            if (selectedDivision != null && selectedDivision != '') {
                $.getJSON(config.spaces + '?where=Lot_Row_ID%3D\'' + Lot_ID + 
