...
Namespace Migrations
    Public NotInheritable Partial Class Assignment_Date
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Assignment_Date))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308151334291_Assignment_Date"
            End Get
        End Property
