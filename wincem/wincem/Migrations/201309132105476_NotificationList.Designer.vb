...
Namespace Migrations
    Public NotInheritable Partial Class NotificationList
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(NotificationList))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201309132105476_NotificationList"
            End Get
        End Property
