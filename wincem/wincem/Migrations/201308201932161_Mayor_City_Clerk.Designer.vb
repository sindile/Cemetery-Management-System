...
Namespace Migrations
    Public NotInheritable Partial Class Mayor_City_Clerk
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Mayor_City_Clerk))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308201932161_Mayor_City_Clerk"
            End Get
        End Property
