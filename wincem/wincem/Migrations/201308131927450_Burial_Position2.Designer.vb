...
Namespace Migrations
    Public NotInheritable Partial Class Burial_Position2
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Burial_Position2))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308131927450_Burial_Position2"
            End Get
        End Property
