...
Namespace Migrations
    Public NotInheritable Partial Class Field_Verified
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Field_Verified))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201309262018247_Field_Verified"
            End Get
        End Property
