...
Namespace Migrations
    Public NotInheritable Partial Class burial_Record
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(burial_Record))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308231635342_burial_Record"
            End Get
        End Property
