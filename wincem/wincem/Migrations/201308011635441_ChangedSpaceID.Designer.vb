...
Namespace Migrations
    Public NotInheritable Partial Class ChangedSpaceID
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ChangedSpaceID))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308011635441_ChangedSpaceID"
            End Get
        End Property
