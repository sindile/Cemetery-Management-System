...
Namespace Migrations
    Public NotInheritable Partial Class Assignment_Owner
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Assignment_Owner))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308151422540_Assignment_Owner"
            End Get
        End Property
