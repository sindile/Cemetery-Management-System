...
Namespace Migrations
    Public NotInheritable Partial Class Burial_Position
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Burial_Position))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308131848264_Burial_Position"
            End Get
        End Property
