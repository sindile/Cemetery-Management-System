...
Namespace Migrations
    Public NotInheritable Partial Class City_Clerk_Mayor
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(City_Clerk_Mayor))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201308271310173_City_Clerk_Mayor"
            End Get
        End Property
