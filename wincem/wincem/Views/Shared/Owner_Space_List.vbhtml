...
<ul data-role="listview" data-inset="true">
    ...
    Else
        @<li data-theme="b" data-icon="plus" data-iconpos="left" class="ui-disabled">@Html.ActionLink("Add Space", "Create", "Owner_Space", New With {.Owner_ID = ViewBag.Owner_ID, .Deed_Type = ViewBag.Deed_Type, .Available = If(ViewBag.Deed_Type = "A", "No", "Yes")}, New With {.data_ajax = "false"})</li>
    End If
</ul>
@For Each item In Model
    Dim currentItem = item
    @<div data-role="popup" id="ownedSpacePopup_@currentItem.ID" data-theme="a">
        ...
        <ul data-role="listview" data-inset="true" style="min-width: 210px;" data-theme="b">
            ...
            Else
                @<li data-icon="pencil" class = "ui-disabled">@Html.ActionLink("Edit", "Edit", "Owner_Space", New With {.id = currentItem.ID, .Available = "No' OR Available = 'Yes"}, New With {.data_ajax = "false"})</li>
            End If
