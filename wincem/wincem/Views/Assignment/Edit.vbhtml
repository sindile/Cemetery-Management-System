...
End Code
    ...
    <div data-role="page" id="assignmentEditPage" data-add-back-btn="true">
        <div data-theme="b" data-role="header" data-position="fixed">
            <h3>Edit burial Data
            </h3>
            @*@Html.ActionLink("Back", "Details", New With {.id = Model.ID}, New With {.data_role = "button", .data_icon = "arrow-l"})*@
        </div>
        <div data-role="content" id="assignmentEditContent">

@Using Html.BeginForm("Edit", "Assignment", Nothing, FormMethod.Post, New With {.data_ajax = "false"})
    ...
    @<div>
        ...
        <div class="editor-field">
            @Html.DropDownList("Owned_SpaceID", String.Empty)
        ...
        <div class="ui-grid-a">
            <div class="ui-block-a">
                @Html.ActionLink("Cancel", "Details", New With {.id = Model.ID}, New With {.data_role = "button"})
                </div>
