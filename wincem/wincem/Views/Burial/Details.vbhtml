...
End Code
    ...
    <div data-role="page" id="burialDetialsPage">
        <div data-theme="b" data-role="header" data-position="fixed">
            ...
            Else
                @Html.ActionLink("Edit", "Edit", New With {.id = Model.ID}, New With {.data_role = "button", .data_icon = "pencil", .class = "ui-btn-right ui-disabled", .data_ajax = "false"})
            End If
        </div>
        ...
        <div data-role="fieldcontain">
            ...
            Else
                 @Html.ActionLink("View Burial Record (PDF)", "burialRecord", "Burial", New With {.id = Model.ID}, New With {.data_role = "button", .data_icon = "arrow-r", .data_iconpos = "right", .data_ajax = "false", .target = "_blank", .class = "ui-disabled"})
            End If
