...
End Code
    ...
    <div data-role="page" id="burialEditPage">
        ...
        <div data-role="content" id="burialEditContent">

@Using Html.BeginForm("Edit", "Burial", Nothing, FormMethod.Post, New With {.data_ajax = "false", .enctype = "multipart/form-data"})
    ...
    @<div>
        ...
        <div data-role="fieldcontain">
            ...
            <img src="~/Images/@(If(String.IsNullOrEmpty(Model.Burial_Position), "No_Burial", Model.Burial_Position)).png" alt="@(If(String.IsNullOrEmpty(Model.Burial_Position), "No_Burial", Model.Burial_Position))" id="burialImage" />
        </div>
        <div data-role="fieldcontain">
        ...
        <div data-role="fieldcontain">
            @Html.ActionLink("View Deed Info.", "Details", "Owner", New With {.id = Model.OwnerID}, New With {.data_role = "button", .data_icon = "arrow-r", .data_iconpos = "right"})
             @If Not String.IsNullOrEmpty(Model.LF_Burial_Record) Then
               @<a href ="@Model.LF_Burial_Record" data-role="button" data-icon="arrow-r" target="_blank" data-iconpos="right">View Burial permit</a>
            End If
        </div>
...
End Using
 ...
 <script type="text/javascript" src="~/Scripts/Burial-edit-ui.js"></script>
