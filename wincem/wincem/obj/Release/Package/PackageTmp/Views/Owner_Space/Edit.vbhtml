...
End Code
    ...
    <div data-role="page" id="ownedSpaceEditPage">
        ...
        <div data-role="content" id="ownedSpaceEditContent">

@Using Html.BeginForm("Edit", "Owner_Space", FormMethod.Post, New With {.data_ajax = "false"})
